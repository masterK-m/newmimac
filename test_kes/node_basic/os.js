...
console.log('운영체제 정보--------------------');
console.log('os.arch() : ', os.arch()); // process.arch와 동일합니다. 
console.log('os.platform() : ', os.platform()); // process.platform과 동일합니다.
console.log('os.type() : ', os.type()); // 운영체제의 종류를 보여줍니다.
console.log('os.uptime() : ', os.uptime()); // 운영체제 부팅 이후 흐른 시간(초)를 보여줍니다. 
console.log('os.hostname() : ', os.hostname()); // 컴퓨터의 이름을 보여줌니다.  
